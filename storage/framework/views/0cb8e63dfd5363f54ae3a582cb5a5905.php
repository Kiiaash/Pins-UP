...
<?php $__env->startSection('mainbody'); ?>
    ...
    <form action="<?php echo e(route('formvalid',Auth::user()->id)); ?>" method="post">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('switches/switch', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\wamp64\www\Laravel course\pinsup\resources\views/create.blade.php ENDPATH**/ ?>