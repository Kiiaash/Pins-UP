...
<?php $__env->startSection('mainbody'); ?>
    ...
    <a href="#">
        <div class="mid-sec">
            <div class="job-bored">
                <h6 class="mt-3"><?php echo e($post->user_id); ?></h6>
            ...
            <div>
                ...
                <form method="post" action="<?php echo e(route('destroyer',$post->user_id)); ?>">
                    <?php echo csrf_field(); ?>
                ...
                <?php endif; ?>
                <form method="GET" action="<?php echo e(route('show.show',$post->user_id)); ?>">
                    <?php echo csrf_field(); ?>
