<link href="<?php echo e(asset('css/main.css')); ?>" type="text/css" rel="stylesheet">
    ...
    <nav role="navigation" aria-label="<?php echo e(__('Pagination Navigation')); ?>" class="flex items-center justify-between">
        <div class="flex justify-between flex-1 sm:hidden">
            ...
            <?php if($paginator->hasMorePages()): ?>
                <a href="<?php echo e($paginator->nextPageUrl()); ?>" class="">
...
<?php endif; ?>
<?php /**PATH F:\wamp64\www\Laravel course\pinsup\resources\views/vendor/pagination/tailwind.blade.php ENDPATH**/ ?>