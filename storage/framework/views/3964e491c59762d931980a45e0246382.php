...
<form action="<?php echo e(route('edval.update',$eid->id)); ?>" method="POST">
    ...
    style="margin:15px 20px;" value="<?php echo e($eid->job_title); ?>">
    <?php $__errorArgs = ['jobtitle1'];
...
unset($__errorArgs, $__bag); ?>
    ...
    style="margin:15px 20px;" value="<?php echo e($eid->job_poster); ?>">
    <?php $__errorArgs = ['jobposter1'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
    ...
    style="margin:15px 20px; width:550px;height:150px;" value=""><?php echo e($eid->description); ?></textarea>
    <?php $__errorArgs = ['jobdes1'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
    ...
    width:550px; height:150px;"><?php echo e($eid->requirments); ?></textarea>
    <?php $__errorArgs = ['requirments1'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php echo $__env->make('switches.switch', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\wamp64\www\Laravel course\pinsup\resources\views//editsec.blade.php ENDPATH**/ ?>